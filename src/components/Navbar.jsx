    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          {/* Mobile toggle */}
          <button
            className="md:hidden text-slate-400 hover:text-white w-10 h-10 flex items-center justify-center"
            ...
            <div className="p-6 flex flex-col gap-4">
              {links.map((l) => (
                <a
                  ...
                  className="text-slate-300 hover:text-white font-display font-semibold text-lg py-1 border-b border-white/5"
                >
                  {l.label}
                </a>
              ))}
              <a
                href="mailto:rtripathi3113998@gmail.com"
                className="mt-2 px-6 py-3 bg-blue-600 text-white font-bold font-display rounded-xl text-center"
              >
                Hire Me
              </a>
            </div>
